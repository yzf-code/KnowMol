...
deepspeed --include localhost:2,3,4 --master_port 29501 llava/train/train_mem.py \
    --deepspeed scripts/zero2.json \
    --lora_enable True \
    --model_name_or_path ./checkpoints/$MODEL_VERSION \
    --version $PROMPT_VERSION \
    --data_path /home/yangzaifei/MolLLM/data/ChEBI-20_data/new_enhanced_molcap_train.pkl \
