...
deepspeed --include localhost:2,3,4,5,6,7 --master_port 29502 llava/train/train_mem.py \
    ...
    --data_path /home/yangzaifei/MolLLM/data/Mol-Instructions/processed_Molecule-oriented_Instructions/forward_reaction_prediction_train.json \
    ...
    --bf16 True \
    --output_dir $CHECKPOINT_FOLDER_PREFIX/$pretrain_dataset/$TASK-llava-$GRAPH_TOWER-$MODEL_VERSION-finetune_lora_2task \
    --num_train_epochs 15 \
