...
deepspeed --include localhost:5,6,7 --master_port 29503 llava/train/train_mem.py \
    --deepspeed scripts/zero2.json \
    --lora_enable True \
    --model_name_or_path ./checkpoints/$MODEL_VERSION \
    --version $PROMPT_VERSION \
    --data_path /home/yangzaifei/MolLLM/data/Mol-Instructions/processed_Molecule-oriented_Instructions/description_guided_molecule_design_train.json \
    --data_type $TASK \
    ...
    --bf16 True \
    --output_dir $CHECKPOINT_FOLDER_PREFIX/$pretrain_dataset/$TASK-llava-$GRAPH_TOWER-$MODEL_VERSION-finetune_lora\
    --num_train_epochs 15 \
