...
TASK="property_pred"
SUB_TYPE='regression'
deepspeed --include localhost:5,6,7 --master_port 29502 llava/train/train_mem.py \
    --deepspeed scripts/zero2.json \
    --lora_enable True \
    --model_name_or_path ./checkpoints/$MODEL_VERSION \
    --version $PROMPT_VERSION \
    --data_path /home/yangzaifei/MolLLM/data/Mol-Instructions/processed_Molecule-oriented_Instructions/property_prediction_$SUB_TYPE\_train.json \
    --data_type $TASK \
    ...
    --bf16 True \
    --output_dir $CHECKPOINT_FOLDER_PREFIX/$pretrain_dataset/$SUB_TYPE-$TASK-llava-$GRAPH_TOWER-$MODEL_VERSION-finetune_lora-add_seqs \
    --num_train_epochs 15 \
