...
class LlavaGraphLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        fg_atoms: Optional[torch.Tensor] = None,
        ...
        input_ids, attention_mask, past_key_values, inputs_embeds, labels = self.prepare_inputs_labels_for_multimodal(input_ids, attention_mask, past_key_values, labels, graphs, fg_atoms)
        ...
        model_inputs.update(
            {
                ...
                "fg_atoms": kwargs.get("fg_atoms", None),
            }
        )
        return model_inputs
